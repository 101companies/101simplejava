// $ANTLR 3.2 Sep 23, 2009 14:05:07 src/main/java/org/softlang/grammar/Grammar.g 2013-05-08 22:12:45
...
public class GrammarParser extends Parser {
    ...
    public String getGrammarFileName() { return "src/main/java/org/softlang/grammar/Grammar.g"; }
    ...
    // src/main/java/org/softlang/grammar/Grammar.g:25:1: parseGrammar returns [Grammar result] : (prods= parseProduction )* ;
    public final Grammar parseGrammar() throws RecognitionException {
        ...
        try {
            // src/main/java/org/softlang/grammar/Grammar.g:25:39: ( (prods= parseProduction )* )
            // src/main/java/org/softlang/grammar/Grammar.g:26:2: (prods= parseProduction )*
            {
             List<Production> prodsList = new LinkedList<Production>(); 
            // src/main/java/org/softlang/grammar/Grammar.g:27:2: (prods= parseProduction )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // src/main/java/org/softlang/grammar/Grammar.g:27:4: prods= parseProduction
            	    {
    ...
    // src/main/java/org/softlang/grammar/Grammar.g:30:1: parseProduction returns [Production result] : lhs= parseId ':' rhs= parseExpression ';' ;
    public final Production parseProduction() throws RecognitionException {
        ...
        try {
            // src/main/java/org/softlang/grammar/Grammar.g:30:45: (lhs= parseId ':' rhs= parseExpression ';' )
            // src/main/java/org/softlang/grammar/Grammar.g:31:2: lhs= parseId ':' rhs= parseExpression ';'
            {
    ...
    // src/main/java/org/softlang/grammar/Grammar.g:37:1: parseExpression returns [Expression result] : ( parseSequence | parseChoice );
    public final Expression parseExpression() throws RecognitionException {
        ...
        try {
            // src/main/java/org/softlang/grammar/Grammar.g:37:45: ( parseSequence | parseChoice )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // src/main/java/org/softlang/grammar/Grammar.g:38:3: parseSequence
                    {
                    ...
                    break;
                case 2 :
                    // src/main/java/org/softlang/grammar/Grammar.g:39:4: parseChoice
                    {
    ...
    // src/main/java/org/softlang/grammar/Grammar.g:41:1: parseSequence returns [Sequence result] : (list= parseAtom )* ;
    public final Sequence parseSequence() throws RecognitionException {
        ...
        try {
            // src/main/java/org/softlang/grammar/Grammar.g:41:41: ( (list= parseAtom )* )
            // src/main/java/org/softlang/grammar/Grammar.g:42:2: (list= parseAtom )*
            {
             List<Atom> listList = new LinkedList<Atom>(); 
            // src/main/java/org/softlang/grammar/Grammar.g:43:2: (list= parseAtom )*
            loop3:
            do {
                int alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // src/main/java/org/softlang/grammar/Grammar.g:43:4: list= parseAtom
            	    {
    ...
    // src/main/java/org/softlang/grammar/Grammar.g:46:1: parseChoice returns [Choice result] : first= parseId (rest= parseOption )* ;
    public final Choice parseChoice() throws RecognitionException {
        ...
        try {
            // src/main/java/org/softlang/grammar/Grammar.g:46:37: (first= parseId (rest= parseOption )* )
            // src/main/java/org/softlang/grammar/Grammar.g:47:2: first= parseId (rest= parseOption )*
            {
            ...
            // src/main/java/org/softlang/grammar/Grammar.g:49:2: (rest= parseOption )*
            loop4:
            do {
                int alt4=2;
                ...
                switch (alt4) {
            	case 1 :
            	    // src/main/java/org/softlang/grammar/Grammar.g:49:4: rest= parseOption
            	    {
    ...
    // src/main/java/org/softlang/grammar/Grammar.g:52:1: parseAtom returns [Atom result] : ( parseTerminal | parseNonterminal | parseMany );
    public final Atom parseAtom() throws RecognitionException {
        ...
        try {
            // src/main/java/org/softlang/grammar/Grammar.g:52:33: ( parseTerminal | parseNonterminal | parseMany )
            int alt5=3;
            ...
            switch (alt5) {
                case 1 :
                    // src/main/java/org/softlang/grammar/Grammar.g:53:3: parseTerminal
                    {
                    ...
                    break;
                case 2 :
                    // src/main/java/org/softlang/grammar/Grammar.g:54:4: parseNonterminal
                    {
                    ...
                    break;
                case 3 :
                    // src/main/java/org/softlang/grammar/Grammar.g:55:4: parseMany
                    {
    ...
    // src/main/java/org/softlang/grammar/Grammar.g:57:1: parseTerminal returns [Terminal result] : symbol= parseQString ;
    public final Terminal parseTerminal() throws RecognitionException {
        ...
        try {
            // src/main/java/org/softlang/grammar/Grammar.g:57:41: (symbol= parseQString )
            // src/main/java/org/softlang/grammar/Grammar.g:58:2: symbol= parseQString
            {
    ...
    // src/main/java/org/softlang/grammar/Grammar.g:61:1: parseNonterminal returns [Nonterminal result] : label= parseId '=' symbol= parseId ;
    public final Nonterminal parseNonterminal() throws RecognitionException {
        ...
        try {
            // src/main/java/org/softlang/grammar/Grammar.g:61:47: (label= parseId '=' symbol= parseId )
            // src/main/java/org/softlang/grammar/Grammar.g:62:2: label= parseId '=' symbol= parseId
            {
    ...
    // src/main/java/org/softlang/grammar/Grammar.g:67:1: parseOption returns [Option result] : '|' symbol= parseId ;
    public final Option parseOption() throws RecognitionException {
        ...
        try {
            // src/main/java/org/softlang/grammar/Grammar.g:67:37: ( '|' symbol= parseId )
            // src/main/java/org/softlang/grammar/Grammar.g:68:2: '|' symbol= parseId
            {
    ...
    // src/main/java/org/softlang/grammar/Grammar.g:72:1: parseMany returns [Many result] : elem= parseNonterminal '*' ;
    public final Many parseMany() throws RecognitionException {
        ...
        try {
            // src/main/java/org/softlang/grammar/Grammar.g:72:33: (elem= parseNonterminal '*' )
            // src/main/java/org/softlang/grammar/Grammar.g:73:2: elem= parseNonterminal '*'
            {
    ...
    // $ANTLR start "parseId"
    // src/main/java/org/softlang/grammar/Grammar.g:77:1: parseId returns [String result] : ID ;
    public final String parseId() throws RecognitionException {
        ...
        try {
            // src/main/java/org/softlang/grammar/Grammar.g:77:33: ( ID )
            // src/main/java/org/softlang/grammar/Grammar.g:78:2: ID
            {
    ...
    // src/main/java/org/softlang/grammar/Grammar.g:82:1: parseQString returns [String result] : QSTRING ;
    public final String parseQString() throws RecognitionException {
        ...
        try {
            // src/main/java/org/softlang/grammar/Grammar.g:82:38: ( QSTRING )
            // src/main/java/org/softlang/grammar/Grammar.g:83:2: QSTRING
            {
    ...
    // src/main/java/org/softlang/grammar/Grammar.g:87:1: parseQqString returns [String result] : QQSTRING ;
    public final String parseQqString() throws RecognitionException {
        ...
        try {
            // src/main/java/org/softlang/grammar/Grammar.g:87:39: ( QQSTRING )
            // src/main/java/org/softlang/grammar/Grammar.g:88:2: QQSTRING
            {
    ...
    // src/main/java/org/softlang/grammar/Grammar.g:92:1: parseNumber returns [Number result] : NUMBER ;
    public final Number parseNumber() throws RecognitionException {
        ...
        try {
            // src/main/java/org/softlang/grammar/Grammar.g:92:37: ( NUMBER )
            // src/main/java/org/softlang/grammar/Grammar.g:93:2: NUMBER
            {
